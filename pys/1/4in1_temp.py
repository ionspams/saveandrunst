...
# Function to check for consecutive matching characters considering only numbers
...
# New function to merge datasets based on common fields and transpose additional fields
    ...
    for index, target_row in target_df.iterrows():
        ...
        if len(matching_base_rows) == 1:
            ...
            for field in additional_fields:
                merged_df.at[index, field] = matching_base_rows.iloc[0][field]
